...
if (typeof gdjs.evtsExt__JointConnector__CreateDistanceJoints !== "undefined") {
  gdjs.evtsExt__JointConnector__CreateDistanceJoints.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__JointConnector__CreateDistanceJoints = {};
gdjs.evtsExt__JointConnector__CreateDistanceJoints.GDObjectObjects1= [];
gdjs.evtsExt__JointConnector__CreateDistanceJoints.GDJointObjects1= [];


gdjs.evtsExt__JointConnector__CreateDistanceJoints.userFunc0x199af88 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__JointConnector__CreateDistanceJoints.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__JointConnector__CreateDistanceJoints.userFunc0x199af88(runtimeScene, objects, eventsFunctionContext);
...
gdjs.evtsExt__JointConnector__CreateDistanceJoints.func = function(runtimeScene, Object, Physics, Joint, parentEventsFunctionContext) {
...
gdjs.evtsExt__JointConnector__CreateDistanceJoints.GDObjectObjects1.length = 0;
gdjs.evtsExt__JointConnector__CreateDistanceJoints.GDJointObjects1.length = 0;

gdjs.evtsExt__JointConnector__CreateDistanceJoints.eventsList0(runtimeScene, eventsFunctionContext);
gdjs.evtsExt__JointConnector__CreateDistanceJoints.GDObjectObjects1.length = 0;
gdjs.evtsExt__JointConnector__CreateDistanceJoints.GDJointObjects1.length = 0;
...
gdjs.evtsExt__JointConnector__CreateDistanceJoints.registeredGdjsCallbacks = [];