...
{
{runtimeScene.getScene().getVariables().get("__MultitouchJoystick").getChild("Controllers").getChild((Number(eventsFunctionContext.getArgument("ControllerIdentifier")) || 0)).getChild("Joystick").getChild("" + eventsFunctionContext.getArgument("JoystickIdentifier")).getChild("Angle").setNumber((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}
