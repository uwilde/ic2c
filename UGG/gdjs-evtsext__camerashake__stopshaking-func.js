...
{runtimeScene.getScene().getVariables().get("__CameraShake").getChild("Duration").setNumber((Number(eventsFunctionContext.getArgument("EaseDuration")) || 0));
}
{runtimeScene.getScene().getVariables().get("__CameraShake").getChild("StopEaseDuration").setNumber((Number(eventsFunctionContext.getArgument("EaseDuration")) || 0));
}
}
