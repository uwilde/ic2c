...
{eventsFunctionContext.returnValue = (( gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.ValueContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.ValueContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getValue());}
}
...
{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.SetValueContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.SetValueContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setValue(gdjs.evtTools.common.clamp((Number(eventsFunctionContext.getArgument("Value")) || 0), 0, (gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.SetValueContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior")).MaxValue(eventsFunctionContext))));
}
}
}
...
{eventsFunctionContext.returnValue = (( gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.MaxValueContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.MaxValueContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getMaxValue());}
}
...
{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.SetMaxValueContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.SetMaxValueContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setMaxValue((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}
}
...
{eventsFunctionContext.returnValue = (( gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.PreviousHighValueContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.PreviousHighValueContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getPreviousHighValue());}
}
...
{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.SetPreviousHighValueDurationContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.SetPreviousHighValueDurationContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setPreviousHighValueDuration((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}
}
...
for (var i = 0, k = 0, l = gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.IsChangingContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.IsChangingContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior")).PreviousHighValue(eventsFunctionContext) != (gdjs.evtsExt__TiledUnitsBar__ResourceBar.ResourceBar.prototype.IsChangingContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getValue()) ) {
        isConditionTrue_0 = true;
