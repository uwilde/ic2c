...
{gdjs.evtTools.sound.setSoundOnChannelVolume(runtimeScene, (Number(eventsFunctionContext.getArgument("Channel")) || 0), gdjs.evtTools.common.lerp((Number(eventsFunctionContext.getArgument("MinVol")) || 0), (Number(eventsFunctionContext.getArgument("MaxVol")) || 0), Math.max(((Number(eventsFunctionContext.getArgument("MaxDistance")) || 0) - gdjs.evtTools.common.distanceBetweenPositions((( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getY()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getY()))) / (Number(eventsFunctionContext.getArgument("MaxDistance")) || 0), 0)));
}
}
...
gdjs.copyArray(eventsFunctionContext.getObjects("Source"), gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1);
gdjs.copyArray(eventsFunctionContext.getObjects("Target"), gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1);
{gdjs.evtTools.sound.setMusicOnChannelVolume(runtimeScene, (Number(eventsFunctionContext.getArgument("Channel")) || 0), gdjs.evtTools.common.lerp((Number(eventsFunctionContext.getArgument("MinVol")) || 0), (Number(eventsFunctionContext.getArgument("MaxVol")) || 0), Math.max(((Number(eventsFunctionContext.getArgument("MaxDistance")) || 0) - gdjs.evtTools.common.distanceBetweenPositions((( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getY()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getY()))) / (Number(eventsFunctionContext.getArgument("MaxDistance")) || 0), 0)));
}
}
