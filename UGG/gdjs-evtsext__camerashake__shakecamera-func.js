...
{runtimeScene.getScene().getVariables().get("__CameraShake").getChild("StartEaseDuration").setNumber((Number(eventsFunctionContext.getArgument("StartEaseDuration")) || 0));
}
{runtimeScene.getScene().getVariables().get("__CameraShake").getChild("StopEaseDuration").setNumber((Number(eventsFunctionContext.getArgument("StopEaseDuration")) || 0));
}
}
...
{runtimeScene.getScene().getVariables().get("__CameraShake").getChild("StartEaseDuration").setNumber((Number(eventsFunctionContext.getArgument("StartEaseDuration")) || 0) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__CameraShake").getChild("Duration")) / ((Number(eventsFunctionContext.getArgument("StartEaseDuration")) || 0) + (Number(eventsFunctionContext.getArgument("StopEaseDuration")) || 0)));
}
