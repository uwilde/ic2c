...
isConditionTrue_0 = gdjs.evtsExt__SpriteMultitouchJoystick__JoystickForce.func(runtimeScene, (Number(eventsFunctionContext.getArgument("ControllerIdentifier")) || 0), "" + eventsFunctionContext.getArgument("JoystickIdentifier"), eventsFunctionContext) > gdjs.evtsExt__SpriteMultitouchJoystick__DeadZone.func(runtimeScene, (Number(eventsFunctionContext.getArgument("ControllerIdentifier")) || 0), "" + eventsFunctionContext.getArgument("JoystickIdentifier"), eventsFunctionContext);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__SpriteMultitouchJoystick__IsAngleIn4WayDirection.func(runtimeScene, gdjs.evtsExt__SpriteMultitouchJoystick__JoystickAngle.func(runtimeScene, (Number(eventsFunctionContext.getArgument("ControllerIdentifier")) || 0), "" + eventsFunctionContext.getArgument("JoystickIdentifier"), eventsFunctionContext), "" + eventsFunctionContext.getArgument("Direction"), eventsFunctionContext);
}
if (isConditionTrue_0) {
